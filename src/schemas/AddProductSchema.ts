...
export const AddProductSchema = z.object({
  product_name: z.string({ message: "El nombre del producto es requerido" }).min(1, {message: "El nombre del producto es requerido"}).max(40, { message: "El nombre debe tener  maximo 40 caracteres" }),
